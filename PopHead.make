...
ifeq ($(config),debug_32bit)
  RESCOMP = windres
  TARGETDIR = bin/Debug_32bit-linux-x86/PopHead
  TARGET = $(TARGETDIR)/PopHead
  OBJDIR = bin-obj/Debug_32bit-linux-x86/PopHead
  PCH = src/pch.hpp
  GCH = $(OBJDIR)/$(notdir $(PCH)).gch
  DEFINES += -DSFML_STATIC -DGLEW_STATIC
  INCLUDES += -Isrc -Ivendor/SFML_2.5.1/include -Ivendor/glew-2.1.0/include -Ivendor/stb -Ivendor/entt-3.2.0/src -Ivendor/imgui
...
ifeq ($(config),release_32bit)
  RESCOMP = windres
  TARGETDIR = bin/Release_32bit-linux-x86/PopHead
  TARGET = $(TARGETDIR)/PopHead
  OBJDIR = bin-obj/Release_32bit-linux-x86/PopHead
  PCH = src/pch.hpp
  GCH = $(OBJDIR)/$(notdir $(PCH)).gch
  DEFINES += -DSFML_STATIC -DGLEW_STATIC
  INCLUDES += -Isrc -Ivendor/SFML_2.5.1/include -Ivendor/glew-2.1.0/include -Ivendor/stb -Ivendor/entt-3.2.0/src -Ivendor/imgui
  ...
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += -lopengl32.lib -lwinmm.lib -lgdi32.lib -lfreetype.lib -lflac.lib -lvorbisenc.lib -lvorbisfile.lib -lvorbis.lib -logg.lib -lopenal32.lib -lglew32s.lib -lsfml-graphics-s -lsfml-audio-s -lsfml-window-s -lsfml-system-s -lsfml-main
  LDDEPS +=
...
ifeq ($(config),distribution_32bit)
  RESCOMP = windres
  TARGETDIR = bin/Distribution_32bit-linux-x86/PopHead
  TARGET = $(TARGETDIR)/PopHead
  OBJDIR = bin-obj/Distribution_32bit-linux-x86/PopHead
  PCH = src/pch.hpp
  GCH = $(OBJDIR)/$(notdir $(PCH)).gch
...
ifeq ($(config),profiling_32bit)
  RESCOMP = windres
  TARGETDIR = bin/Profiling_32bit-linux-x86/PopHead
  TARGET = $(TARGETDIR)/PopHead
  OBJDIR = bin-obj/Profiling_32bit-linux-x86/PopHead
  PCH = src/pch.hpp
  GCH = $(OBJDIR)/$(notdir $(PCH)).gch
...
ifeq ($(config),tests_32bit)
  RESCOMP = windres
  TARGETDIR = bin/Tests_32bit-linux-x86/PopHead
  TARGET = $(TARGETDIR)/PopHead
  OBJDIR = bin-obj/Tests_32bit-linux-x86/PopHead
  PCH = src/pch.hpp
  GCH = $(OBJDIR)/$(notdir $(PCH)).gch
  DEFINES += -DSFML_STATIC -DGLEW_STATIC
  INCLUDES += -Isrc -Ivendor/SFML_2.5.1/include -Ivendor/glew-2.1.0/include -Ivendor/stb -Ivendor/entt-3.2.0/src -Ivendor/imgui
  FORCE_INCLUDE += -include $(OBJDIR)/$(notdir $(PCH))
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m32 -Wno-4996
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m32 -std=c++17 -Wno-4996
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += -lopengl32.lib -lwinmm.lib -lgdi32.lib -lfreetype.lib -lflac.lib -lvorbisenc.lib -lvorbisfile.lib -lvorbis.lib -logg.lib -lopenal32.lib -lglew32s.lib
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -Lvendor/SFML_2.5.1/lib-VisualStudio-32bit -Lvendor/glew-2.1.0/lib/32bit -L/usr/lib32 -m32 -s
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
...
ifeq ($(config),debug_64bit)
  RESCOMP = windres
  TARGETDIR = bin/Debug_64bit-linux-x86_64/PopHead
  TARGET = $(TARGETDIR)/PopHead
  OBJDIR = bin-obj/Debug_64bit-linux-x86_64/PopHead
  PCH = src/pch.hpp
  GCH = $(OBJDIR)/$(notdir $(PCH)).gch
  # DEFINES += -DSFML_STATIC -DGLEW_STATIC
  INCLUDES += -Isrc `pkg-config --cflags sfml-all glew openal` -I/usr/include/stb -Ivendor/entt-3.2.0/src -Ivendor/imgui
  FORCE_INCLUDE += -include $(OBJDIR)/$(notdir $(PCH))
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -g -Wno-4996
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -g -std=c++17 -Wno-4996
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += `pkg-config --libs sfml-all glew openal`
  # -lopengl32.lib -lfreetype.lib -lflac.lib -lvorbisenc.lib -lvorbisfile.lib -lvorbis.lib -logg.lib
  LDDEPS +=
...
ifeq ($(config),release_64bit)
  RESCOMP = windres
  TARGETDIR = bin/Release_64bit-linux-x86_64/PopHead
  TARGET = $(TARGETDIR)/PopHead
  OBJDIR = bin-obj/Release_64bit-linux-x86_64/PopHead
  PCH = src/pch.hpp
  GCH = $(OBJDIR)/$(notdir $(PCH)).gch
  DEFINES += -DSFML_STATIC -DGLEW_STATIC
  INCLUDES += -Isrc -Ivendor/SFML_2.5.1/include -Ivendor/glew-2.1.0/include -Ivendor/stb -Ivendor/entt-3.2.0/src -Ivendor/imgui
...
ifeq ($(config),distribution_64bit)
  RESCOMP = windres
  TARGETDIR = bin/Distribution_64bit-linux-x86_64/PopHead
  TARGET = $(TARGETDIR)/PopHead
  OBJDIR = bin-obj/Distribution_64bit-linux-x86_64/PopHead
  PCH = src/pch.hpp
  GCH = $(OBJDIR)/$(notdir $(PCH)).gch
  DEFINES += -DSFML_STATIC -DGLEW_STATIC -DPH_DISTRIBUTION
  INCLUDES += -Isrc -Ivendor/SFML_2.5.1/include -Ivendor/glew-2.1.0/include -Ivendor/stb -Ivendor/entt-3.2.0/src -Ivendor/imgui
...
ifeq ($(config),profiling_64bit)
  RESCOMP = windres
  TARGETDIR = bin/Profiling_64bit-linux-x86_64/PopHead
  TARGET = $(TARGETDIR)/PopHead
  OBJDIR = bin-obj/Profiling_64bit-linux-x86_64/PopHead
  PCH = src/pch.hpp
  GCH = $(OBJDIR)/$(notdir $(PCH)).gch
  DEFINES += -DSFML_STATIC -DGLEW_STATIC -DPH_PROFILING
  INCLUDES += -Isrc -Ivendor/SFML_2.5.1/include -Ivendor/glew-2.1.0/include -Ivendor/stb -Ivendor/entt-3.2.0/src -Ivendor/imgui
...
ifeq ($(config),tests_64bit)
  RESCOMP = windres
  TARGETDIR = bin/Tests_64bit-linux-x86_64/PopHead
  TARGET = $(TARGETDIR)/PopHead
  OBJDIR = bin-obj/Tests_64bit-linux-x86_64/PopHead
  PCH = src/pch.hpp
  GCH = $(OBJDIR)/$(notdir $(PCH)).gch
  DEFINES += -DSFML_STATIC -DGLEW_STATIC
  INCLUDES += -Isrc -Ivendor/SFML_2.5.1/include -Ivendor/glew-2.1.0/include -Ivendor/stb -Ivendor/entt-3.2.0/src -Ivendor/imgui
  FORCE_INCLUDE += -include $(OBJDIR)/$(notdir $(PCH))
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -Wno-4996
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -std=c++17 -Wno-4996
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += -lopengl32.lib -lwinmm.lib -lgdi32.lib -lfreetype.lib -lflac.lib -lvorbisenc.lib -lvorbisfile.lib -lvorbis.lib -logg.lib -lopenal32.lib -lglew32s.lib
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -Lvendor/SFML_2.5.1/lib-VisualStudio-64bit -Lvendor/glew-2.1.0/lib/64bit -L/usr/lib64 -m64 -s
